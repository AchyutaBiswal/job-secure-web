package com.achyuta.JobSecureWeb.repo;
...
//array list to store JobPost objects
    ...
    //method to return all getAllJobs

    public List<JobPost> getAllJobs(){
        return jobs;
    }

    //method to save a job post objects into arraylist
